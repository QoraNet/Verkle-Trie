...
func getCodeChunkKey(address common.Address, chunkNumber int) trie.Key {
	// Derived from
	// https://github.com/ethereum/go-ethereum/blob/e563918a84b4104e44935ddc6850f11738dcc3f5/trie/utils/verkle.go#L188
	var (
...
func getStorageKey(address common.Address, key common.Key) trie.Key {
	// Derived from
	// https://github.com/ethereum/go-ethereum/blob/e563918a84b4104e44935ddc6850f11738dcc3f5/trie/utils/verkle.go#L203
...
func getTrieKey(
	...
	// Inspired by https://github.com/ethereum/go-ethereum/blob/e563918a84b4104e44935ddc6850f11738dcc3f5/trie/utils/verkle.go#L116
